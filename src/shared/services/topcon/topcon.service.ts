...
import { Station } from '../../interfaces/topcon/station.model';
import { Point } from '../../interfaces/topcon/point.model';
import { converteToDecimalDegrees, converteToMeters } from '../../utils/common-functions/topcon/transformations';
...
export class TopconService {
    ...
    private parsePoints(pointsArr: string[]): any {
        ...
        const points = [];
        let newStation: Station | any = {};
        let newPoint: Point | any = {isEmpty: true};
        const UNITS: any = {};
