...
export const dataToExel_Carlson = function (pointsArray: any[]) {
  const data = [
    [
      'Point Number',
  ...
  pointsArray.forEach((point: any) => {
    const exelArray = [
      ...
      validateValue(point.elevation - point.enteredRoverHR) ||
        validateValue(point.data.elevation - point.enteredRoverHR),
