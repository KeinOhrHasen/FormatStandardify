import { __commonJS, __require } from './chunk-EIB7IA3J.js';
    ...
    (function (global, factory) {
      ...
      function isValid(m) {
        ...
        if (isNowValid) {
          ...
          if (m._strict) {
            isNowValid =
              isNowValid && flags.charsLeftOver === 0 && flags.unusedTokens.length === 0 && flags.bigHour === void 0;
          }
        }
      ...
      function localeMonths(m, format2) {
        ...
        return isArray(this._months)
          ...
          : this._months[(this._months.isFormat || MONTHS_IN_FORMAT).test(format2) ? 'format' : 'standalone'][
              m.month()
            ];
      }
      ...
      function localeWeekdays(m, format2) {
        var weekdays = isArray(this._weekdays)
          ? this._weekdays
          : this._weekdays[m && m !== true && this._weekdays.isFormat.test(format2) ? 'format' : 'standalone'];
      ...
      function bubble() {
        var milliseconds2 = this._milliseconds,
          ...
          monthsFromDays;
        if (
          !((milliseconds2 >= 0 && days2 >= 0 && months2 >= 0) || (milliseconds2 <= 0 && days2 <= 0 && months2 <= 0))
        ) {
