import { NG_VALUE_ACCESSOR } from './chunk-ZYRYXJL6.js';
import { UniqueSelectionDispatcher } from './chunk-6UTGIVSC.js';
import {
  FocusMonitor,
  MatCommonModule,
  MatRipple,
...
var MatRadioButton = class _MatRadioButton {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatRadioButton_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute('id', ctx.id)('tabindex', null)('aria-label', null)('aria-labelledby', null)(
          'aria-describedby',
          null,
        );
        ɵɵclassProp('mat-primary', ctx.color === 'primary')('mat-accent', ctx.color === 'accent')(
          'mat-warn',
          ctx.color === 'warn',
        )('mat-mdc-radio-checked', ctx.checked)('mat-mdc-radio-disabled', ctx.disabled)(
    ...
    consts: [
      ...
      ['type', 'radio', 1, 'mdc-radio__native-control', 3, 'change', 'id', 'checked', 'disabled', 'required'],
    ...
    template: function MatRadioButton_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵadvance(2);
        ɵɵproperty('id', ctx.inputId)('checked', ctx.checked)('disabled', ctx.disabled && !ctx.disabledInteractive)(
          'required',
          ctx.required,
        );
        ɵɵattribute('name', ctx.name)('value', ctx.value)('aria-label', ctx.ariaLabel)(
          'aria-labelledby',
          ctx.ariaLabelledby,
        ...
        ɵɵadvance(5);
        ɵɵproperty('matRippleTrigger', ctx._rippleTrigger.nativeElement)('matRippleDisabled', ctx._isRippleDisabled())(
          'matRippleCentered',
          true,
        );
        ɵɵadvance(2);
