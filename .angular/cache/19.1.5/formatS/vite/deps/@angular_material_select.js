import { CdkConnectedOverlay, CdkOverlayOrigin, Overlay, OverlayModule } from './chunk-NKFDTGN4.js';
import { FormGroupDirective, NgControl, NgForm, Validators } from './chunk-ZYRYXJL6.js';
import { CdkScrollableModule, ViewportRuler } from './chunk-7OXS36IX.js';
import { SelectionModel } from './chunk-6UTGIVSC.js';
import {
  MAT_FORM_FIELD,
  MatError,
  MatFormField,
  ...
  MatPrefix,
  MatSuffix,
} from './chunk-IZAAV4VJ.js';
import { animate, animateChild, query, state, style, transition, trigger } from './chunk-JCA25CYI.js';
import {
  A,
...
import { NgClass } from './chunk-HKR3VAT5.js';
import {
...
function MatSelect_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener(
      '@transformPanel.done',
      function MatSelect_ng_template_10_Template_div_animation_transformPanel_done_0_listener($event) {
        ɵɵrestoreView(_r3);
        const ctx_r1 = ɵɵnextContext();
  ...
  if (rf & 2) {
    ...
    ɵɵattribute('id', ctx_r1.id + '-panel')('aria-multiselectable', ctx_r1.multiple)(
      'aria-label',
...
var MatSelect = class _MatSelect {
  ...
  _getOverlayWidth(preferredOrigin) {
    if (this.panelWidth === 'auto') {
      const refToMeasure =
        preferredOrigin instanceof CdkOverlayOrigin ? preferredOrigin.elementRef : preferredOrigin || this._elementRef;
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatSelect_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        )('aria-disabled', ctx.disabled.toString())('aria-invalid', ctx.errorState)(
          'aria-activedescendant',
          ctx._getAriaActiveDescendant(),
        );
        ɵɵclassProp('mat-mdc-select-disabled', ctx.disabled)('mat-mdc-select-invalid', ctx.errorState)(
          'mat-mdc-select-required',
          ctx.required,
        )('mat-mdc-select-empty', ctx.empty)('mat-mdc-select-multiple', ctx.multiple);
      }
    },
    inputs: {
    ...
    consts: [
      ...
      ['viewBox', '0 0 24 24', 'width', '24px', 'height', '24px', 'focusable', 'false', 'aria-hidden', 'true'],
      ['d', 'M7 10l5 5 5-5z'],
      [
    ...
    template: function MatSelect_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty('cdkConnectedOverlayPanelClass', ctx._overlayPanelClass)(
          'cdkConnectedOverlayScrollStrategy',
          ctx._scrollStrategy,
        )('cdkConnectedOverlayOrigin', ctx._preferredOverlayOrigin || fallbackOverlayOrigin_r4)(
          'cdkConnectedOverlayOpen',
          ctx.panelOpen,
        )('cdkConnectedOverlayPositions', ctx._positions)('cdkConnectedOverlayWidth', ctx._overlayWidth);
      }
    },
