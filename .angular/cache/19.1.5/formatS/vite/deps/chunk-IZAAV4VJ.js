import { animate, state, style, transition, trigger } from './chunk-JCA25CYI.js';
import { MatCommonModule, ObserversModule, _IdGenerator } from './chunk-H7FL5DP7.js';
import { Directionality } from './chunk-WKOARE77.js';
import { Platform, coerceBooleanProperty } from './chunk-QDQUQZPY.js';
import { NgTemplateOutlet } from './chunk-HKR3VAT5.js';
import {
...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges = control.stateChanges
      .pipe(
        startWith([void 0, void 0]),
        map(() => [control.errorState, control.userAriaDescribedBy]),
        pairwise(),
  ...
  _updateOutlineLabelOffset() {
    ...
    const prefixAndSuffixWidth =
      iconPrefixContainerWidth + textPrefixContainerWidth + iconSuffixContainerWidth + textSuffixContainerWidth;
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatFormField_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('mat-mdc-form-field-label-always-float', ctx._shouldAlwaysFloat())(
          'mat-mdc-form-field-has-icon-prefix',
          ctx._hasIconPrefix,
        )('mat-mdc-form-field-has-icon-suffix', ctx._hasIconSuffix)('mat-form-field-invalid', ctx._control.errorState)(
        ...
        )('mat-form-field-hide-placeholder', ctx._hasFloatingLabel() && !ctx._shouldLabelFloat())(
          'mat-focused',
          ctx._control.focused,
        )('mat-primary', ctx.color !== 'accent' && ctx.color !== 'warn')('mat-accent', ctx.color === 'accent')(
          'mat-warn',
          ctx.color === 'warn',
        )('ng-untouched', ctx._shouldForward('untouched'))('ng-touched', ctx._shouldForward('touched'))(
          'ng-pristine',
          ctx._shouldForward('pristine'),
        )('ng-dirty', ctx._shouldForward('dirty'))('ng-valid', ctx._shouldForward('valid'))(
          'ng-invalid',
    ...
    consts: [
      ...
      ['matFormFieldLineRipple', ''],
      [1, 'mat-mdc-form-field-subscript-wrapper', 'mat-mdc-form-field-bottom-align'],
    ...
    template: function MatFormField_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(6, MatFormField_Conditional_6_Template, 2, 2, 'div', 9)(
          7,
          ...
          'div',
          10,
        )(8, MatFormField_Conditional_8_Template, 3, 0, 'div', 11);
        ɵɵelementStart(9, 'div', 12);
        ɵɵtemplate(10, MatFormField_Conditional_10_Template, 1, 1, null, 13);
        ɵɵprojection(11);
        ɵɵelementEnd();
        ɵɵtemplate(12, MatFormField_Conditional_12_Template, 3, 0, 'div', 14)(
          13,
        ...
        ɵɵtemplate(16, MatFormField_Case_16_Template, 2, 1, 'div', 18)(
          17,
      ...
      if (rf & 2) {
        let tmp_16_0;
        ɵɵadvance(2);
        ɵɵclassProp('mdc-text-field--filled', !ctx._hasOutline())('mdc-text-field--outlined', ctx._hasOutline())(
          'mdc-text-field--no-label',
          !ctx._hasFloatingLabel(),
        )('mdc-text-field--disabled', ctx._control.disabled)('mdc-text-field--invalid', ctx._control.errorState);
        ɵɵadvance(2);
...
//# sourceMappingURL=chunk-IZAAV4VJ.js.map
